...
namespace MyApp
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source C:\Users\ikaplan\Desktop\MyApp\MyApp.Shared\App.xaml (Line 1:2)
			...
			global::MyApp.Wasm.GlobalStaticResources.Initialize();
			global::MyApp.Wasm.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::MyApp.Wasm.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::MyApp.Wasm.Resource.Drawable);
			#endif
			...
			;
			// Source ..\..\..\..\..\..\..\MyApp.Shared\App.xaml (Line 1:2)
		}
	}
}
namespace MyApp.Wasm
{
	static class App_999104a5c4d6964219985992b74fd2f7XamlApplyExtensions
	{
	}
}
